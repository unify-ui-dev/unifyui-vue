    ...
    <section class="min-h-max bg-purple-50 dark-bg-gray-950">
        ...
        <div class="w-full flex items-center relative">
            ...
            <div px="5 sm:10 md:12 lg:5" class="min-h-max relative mx-auto pt32 lg-max-w-7xl w-full text-center space-y-10">
                ...
                <div p="x2 t2" class="mx-auto max-w-6xl rd-t-2xl aspect-[5/2.3] overflow-hidden bg-gradient-to-t from-gray-50 to-gray-2 dark-from-gray-950 dark-to-gray-9">
                    <img src="/images/Overview.png" width="1440" height="1024" alt="product image" class="rd-2xl w-full h-auto">
                </div>
            </div>
        </div>
    </section>
